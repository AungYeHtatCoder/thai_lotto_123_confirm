  ...
  <div class="col-lg-4 col-md-4 offset-lg-4 offset-md-4 navs fixed-top">
    <div class="px-3 py-3">
      <div class="d-flex justify-content-between">
        ...
        <h5 class="mx-auto">
          <a href="../index.html" class="text-white">Thai Lotto 123</a>
        </h5>
        <span>
          <a class="material-icons text-white" href="{{ url('/user/get-three-d') }}">refresh</a>
        </span>
      </div>
    </div>
  </div>
...
<div class="row" style="height: 100vh">
  <div class="col-lg-4 col-md-4 offset-lg-4 offset-md-4 mt-5 py-4" style="background-color: #b6c5d8">
    ...
    <div class="d-flex justify-content-around align-items-center my-3">
      ...
      <input id="numberInput" type="text" class="form-control border border-none py-2 mx-2 w-100" id="exampleInput" placeholder="စာရိုက်ပြီး ဂဏန်းရွေးမည်" maxlength="3" required />
