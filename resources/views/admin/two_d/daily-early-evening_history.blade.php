        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <div class="d-lg-flex">
                        <div>
                            <h5 class="mb-0">2D - 2:00 စာရင်း ပေါင်းချုပ် -   Dashboards
                                <span>
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                 <a href="{{ url('/admin/twod-daily-early-evening-history') }}"
                                    class="btn bg-gradient-primary btn-sm mb-0"> > &nbsp; 2:00 စာရင်း ပေါင်းချုပ်</a>
