 ...
 <div class="col-12">
  <div class="card">
   ...
   <div class="card-header pb-0">
    <div class="d-lg-flex">
     <div>
      <h5 class="mb-0">Baht Limit Dashboards</h5>
        ...
        <div class="modal-dialog mt-lg-10">
         <div class="modal-content">
          <div class="modal-header">
           <h5 class="modal-title" id="ModalLabel">Create New Baht Limit</h5>
           <i class="material-icons ms-3">file_upload</i>
           <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
           <p>You can create new Baht Limit.</p>
           <form class="multisteps-form__form" action="{{ route('admin.baht-break-limit.store') }}" method="post">
            @csrf
            <div class="input-group input-group-dynamic mb-3">
             <label class="form-label">Baht Limit </label>
             <input type="text" class="form-control" name="baht_limit" onfocus="focused(this)" onfocusout="defocused(this)">
            </div>
            <div class="modal-footer">
             <button type="button" class="btn bg-gradient-secondary btn-sm" data-bs-dismiss="modal">Close</button>
             <button type="submit" class="btn bg-gradient-primary btn-sm">Save Baht Limit<button>
            </div>
           </form>
    ...
    <table class="table table-flush" id="permission-search">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td class="text-sm font-weight-normal">{{ $limit->baht_limit }} </td>
       ...
       <td>
        ...
        <form class="d-inline" action="{{ route('admin.baht-break-limit.destroy', $limit->id) }}" method="POST">
         @csrf
         @method('DELETE')
