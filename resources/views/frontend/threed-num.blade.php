...
<div class="row" style="padding-bottom: 50px">
  <div class="col-lg-4 col-md-4 offset-lg-4 offset-md-4 mt-5 py-4" style="background-color: #b6c5d8">
    ...
    <div class="d-flex justify-content-around align-items-center my-3">
      <input id="numberInput" type="number" class="form-control border border-none py-2 mx-2 w-100" id="exampleInput" placeholder="စာရိုက်ပြီး ဂဏန်းရွေးမည်" maxlength="3" required />
