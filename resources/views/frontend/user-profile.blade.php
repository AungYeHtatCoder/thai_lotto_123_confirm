...
<div style="margin-top: 80px;">
 <form id="uploadForm" enctype="multipart/form-data ">
  ...
  <div class="d-flex justify-content-center align-items-center my-2">
   <input type="text" value="Su Yee" class="w-75 rounded border border-none p-2" style="font-size: 14px;line-height: 20px;outline: none;color: #757575;" />
  </div>

  <div class="d-flex justify-content-center align-items-center my-2">
   <input type="text" value="09123456789" class="w-75 rounded border border-none p-2" style="font-size: 14px;line-height: 20px;outline: none;color: #C0C0C0;" />
  </div>
