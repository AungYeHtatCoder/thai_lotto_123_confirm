...
<div style="
 ...
 <div class="text-center p-2" style="
  ...
  <p style="font-size: 14px">
   ကျေးဇူးပြု၍ အောက်ပါ KPay အကောင့်သို့ ငွေဖြည့်သွင်းပါ။
  </p>
 </div>
 ...
 <form class="m-2" style="
  ...
  <input type="text" class="form-control" placeholder="" style="
            ...
            " />
  <img src="{{ asset('user_app/assets/img/content_copy.png') }}" style="position: absolute; top: 45px; right: 10px" alt="" />

  <label for="number" class="my-2"> သင်၏ Kpay ဖုန်းနံပါတ်ထည့်ပါ </label>
  <input type="text" class="form-control" placeholder="" style="
              border: 1px solid var(--System-Gray-500, #9e9e9e);
              background: var(--System-White, #fff);
            " />
  ...
  <label for="amount" class="my-2"> ငွေဖြည့်ဖြည့်မည့် ပမာဏ</label>
  <input type="text" class="form-control" placeholder="" style="
              border: 1px solid var(--System-Gray-500, #9e9e9e);
              background: var(--System-White, #fff);
            " />
