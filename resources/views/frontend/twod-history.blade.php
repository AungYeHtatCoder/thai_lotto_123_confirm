...
<div style="
 ...
 <div class="tab d-flex justify-content-around align-items-center m-2">
  <button class="tablinks active bg-transparent" onclick="openTab(event, 'first_tab')">
   <div class="text-center" style="
    ...
    <p class="mt-3" style="font-size: 14px">Morning 2D ထီပေါက််စဉ်</p>
   </div>
  </button>
  <button class="tablinks bg-transparent" onclick="openTab(event, 'second_tab')">
   <div class="text-center" style="
                padding: 12px 16px;
                border-radius: 5px;
                color: #fff;
    ...
    <p class="mt-3" style="font-size: 14px">Evening 2D ထီပေါက််စဉ်</p>
   </div>
  </button>
 </div>
