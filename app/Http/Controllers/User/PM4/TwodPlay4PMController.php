...
class TwodPlay4PMController extends Controller
{
    ...
    return view('two_d.4_pm.twodplay_evening', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('two_d.4_pm.twod_play_confirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
