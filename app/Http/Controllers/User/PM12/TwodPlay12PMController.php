...
class TwodPlay12PMController extends Controller
{
    ...
    return view('two_d.12_pm.twodplay_morning', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('two_d.12_pm.twod_play_confirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
