...
namespace App\Http\Controllers\User\EarlyM;
...
class TwoDplay9AMController extends Controller
{
    ...
    return view('two_d.9_am.twodplay_morning', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('two_d.9_am.twod_play_confirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
