...
class TwodPlay2PMController extends Controller
{
    ...
    return view('two_d.2_pm.twodplay_early_evening', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
    ...
    return view('two_d.2_pm.twod_play_confirm', compact('twoDigits', 'remainingAmounts', 'lottery_matches'));
    }
