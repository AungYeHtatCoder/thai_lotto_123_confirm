...
class DailyHistoryController extends Controller
{
    ...
    public function get121Record()
    {
        $user_id = Auth::user()->id;
        try {
            $startTime = Carbon::today()->timezone('Asia/Yangon')->setHour(9)->setMinute(0);
            $endTime = Carbon::today()->timezone('Asia/Yangon')->setHour(12)->setMinute(0);
